//
// Created by bruno on 26/06/2026.
//
//
#include <stdlib.h>
#include <GL/glut.h>
...
// Função callback chamada quando o tamanho da janela à alterado
void AlteraTamanhoJanela(GLsizei w, GLsizei h)
{
	...
	// Estabelece a janela de seleçãoo (esquerda, direita, inferior,
...
// Função responsavel por inicializar parametros e variaveis
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("OMFG, THIS IS A NICE HOUSE");
	...
	// Chama a função responsavel por fazer as inicializações
	Inicializa();
